...
export default function AiInsightCard({
    ...
    return (
      <Card className="p-6">
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-base font-medium text-gray-600">Aucun rapport AI disponible</p>
          <p className="text-xs text-gray-500 mt-1">Le premier rapport sera généré automatiquement</p>
        </div>
      </Card>
    )
  }
  ...
  return (
    <Card className="p-6">
      ...
      <p className="text-base text-gray-700 leading-relaxed mb-4">{summary}</p>
          ...
          {recommendations.slice(0, 3).map((rec, i) => (
            <div key={i} className="flex items-start gap-2.5 pl-1">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-gray-700">{rec.action}</p>
              </div>
            </div>
          ))}
        </div>
