...
export default async function AlertsPage() {
  ...
  return (
    <div className="space-y-6">
      <Header
        title="Alertes"
        subtitle="Notifications et alertes prioritaires"
      />
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-600 dark:text-slate-300 mb-3">
                Les alertes en temps réel sont réservées aux abonnés Premium. Passez au plan Premium pour bénéficier de :
              </p>
              <ul className="space-y-1.5 text-sm text-gray-700 dark:text-slate-300">
                <li className="flex items-center gap-2">
                  ...
                  Alertes instantanées sur chaque avis négatif
                </li>
                <li className="flex items-center gap-2">
                  <Sparkles className="w-3.5 h-3.5 text-brand-light shrink-0" />
                  Détection de chutes de score SEO
                </li>
                <li className="flex items-center gap-2">
                  <Sparkles className="w-3.5 h-3.5 text-brand-light shrink-0" />
                  Surveillance des changements concurrentiels
                </li>
              </ul>
